...
const styles = {
    ...
    orderDetails: {
        backgroundColor: "#e0f7fa", // 🌊 เปลี่ยนพื้นหลังเป็นฟ้าหม่นคล้ายทะเล
        borderRadius: "10px",
        padding: "15px",
    },
    option: {
        ...
        cursor: "pointer",
        transition: "0.3s",
        color: "#00796b", // 🌴 ตัวอักษรสีเขียวสดเหมือนต้นปาล์ม
    },
    btnPayment: {
        backgroundColor: "#00838f",  // 🌊 ฟ้าครามแบบน้ำทะเล
        ...
        cursor: "pointer",
        boxShadow: "0px 4px 10px rgba(0, 83, 100, 0.3)", // 🌊 เพิ่มเงาฟ้าเหมือนคลื่น
    }
};
